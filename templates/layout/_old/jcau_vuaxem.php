...
<div class="list_carousel_5">
    ...
    <?php } ?>
            ...
            <p class="giaban">Giá : <?php if($sanpham_daxem['giaban']==0) echo _lienhe; else echo number_format ($sanpham_daxem['giaban'],0,",",",")." VNĐ";?></p>
            <?php if($sanpham_daxem['giacu']!=0){?>
            <p class="giacu">Giá cũ : <?php if($sanpham_daxem['giacu']==0) echo _lienhe; else echo number_format ($sanpham_daxem['giacu'],0,",",",")." VNĐ";?></p>
            <?php } ?>
        </a>
        </li>
